...
public class ProductDAO implements IProductDAO {
    ...
    private static final String SELECT_ALL_PRODUCTS = "select id_product, name, price, quantity, color, description, category from product\n" +
    ...
    public ArrayList<Product> getAllProduct() {
        ...
        try (Connection connection = connectionn.getConnection();
...
//            return connectionn.getConnection();
//        }
//    }
}