        ...
        <div class="card-body row">
            <form action="/product?action=editPost&id=${productEdit.getId_product()}" method="post">
                <table border="1" cellpadding="5">
                    ...
                    <tr>
                        <td colspan="2">
                            <button type="submit" class="btn btn-success"><a href="/view.jsp">Update</a></button>
                            <button type="button" class="btn btn-outline-success"><a href="/view.jsp">Back</a></button>
                        </td>
                    </tr>
                    <tr>
