        ...
        <div class="card-body row">
            <form action="/product?action=createPost" method="post">
                <table border="1" cellpadding="5">
                    ...
                    <tr>
                        <td colspan="2">
                            <button type="submit" class="btn btn-warning"><a href="/view.jsp">Create</a></button>
                            <button type="button" class="btn btn-outline-secondary"><a href="/view.jsp">Back</a></button>
                        </td>
                    </tr>
                    <tr>
